...
For local health departments, we recommend going through [this list](.README.md#installation-for-local-health-departments) (below). Our experience is that LHD-managed machines need additional tools and packages installed first. This list will walk you through those steps.
