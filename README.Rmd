...
3. Report Config: YAML file providing additional configuration information, such as:
    ...
    - `trend_threshold`: The threshold for determining the "Trend" column in reports that compute this statistic. A percent change above or below the `trend_threshold` will result in a change in the trend.
